  ...
  return knex('Players').del()
    .then(function () {
      ...
      return knex('Players').insert([
        ...
        {id: 107, firstName: 'Wiremu', surName: 'Sharman', knickName: '', favHand:'',favHeadsUp: '', leastFavHeadsUp: '', image:'/images/wiremu_001.jpg' },
        ...
        {id: 111, firstName: 'Michael', surName: 'Stickney', knickName: 'Maori', favHand:'',favHeadsUp: '', leastFavHeadsUp: '', image:'/images/michael_001.jpg' },
      ]);
    });
};
